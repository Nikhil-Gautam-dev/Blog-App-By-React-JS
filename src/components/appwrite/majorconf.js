...
export class service {
    ...
    async deleteFile(fileID) { // Appwrite me file delete karne ke liye exact fileID dena zaroori hai, parameter me kuch v pass kr skte h but andr v wo consist krna chahiye
        try {
